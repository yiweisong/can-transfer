...
from packages.common.context import AppContext
...
def transfer_task():
    ...
    def handle_wheel_speed_data(event_time, speed, gear):
        try:
            transfer_center.dispatch_vehicle_speed(speed, gear)
        ...
        # log timestamp
        can_speed_log.append('{0}, {1}, {2}'.format(event_time, speed, gear))
